...
# bash test.sh -u https://192.168.33.18 -t 23bc46b1-71f6-4ed5-8c54-816aa4f8c502:123zO3xZCLrMN6v2BKK1dXYFpXlPkccOFqm12CdAsMgRU4VrNZ9lyGVCGuMDGIwP --owhome /home/openwhisk/openwhisk --owc-initial 1024 --owc-max 10240 --payloads "timeout30 timeout30payload100K" --action sleepy --repeats 2 --step 1024
EOM
}
...
case $key in
    ...
    --owc-initial) owc_initial_memory="$2"; shift ;;
